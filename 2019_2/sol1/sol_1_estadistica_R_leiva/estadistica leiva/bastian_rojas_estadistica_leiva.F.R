...
# bastian_rojas_estadistica_leiva.f
...
mean(pib_per_capita) #2,1
mean(misdatos$esperanza_de_vida) #2,1
sd(misdatos$esperanza_de_vida) #2,2
sd(misdatos$pib_per_capita) #2,2
#nomero de muestras 142 todas las variables
