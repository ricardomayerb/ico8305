...
pob <- misdatos[,5]
pib <- misdatos[,6]
nrow(pais) #cant observaciones de pais
nrow(cont) #cant observaciones de continentes
nrow(anio) #cant observaciones de año
nrow(espe) #cant observaciones de esperanza de vida
nrow(pob) #cant observaciones de poblacion
nrow(pib) #cant observaciones pib per capita
