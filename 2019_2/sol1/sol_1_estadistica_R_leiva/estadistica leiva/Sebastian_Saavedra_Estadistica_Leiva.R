...
# Sebastian_Saavedra_estadistica_Leiva 
...
dim(misdatos) #la preg pide de c/u, pero todas las columnas tienen 142 obs. No me dejo contar para C/u de las variables, pero espero sea suficientes, son 142 y 6 variables.  
hist(misdatos$pib_per_capita)
hist(misdatos$esperanza_de_vida)
hist(log(misdatos$poblacion))
summary(misdatos$pib_per_capita)
