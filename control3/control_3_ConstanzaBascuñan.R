...
# 1) Use la funcion read_excel para importar la base de datos "nombres"60.xlsx" 
...
notas$solemne
notassolemne<-notas$solemne
mean(notassolemne)

notas$examen
notasexamen<-notas$examen
sd(notasexamen)


# 5) Compute los quantiles 0.25 y 0.75 de las notas del examen
quantile(notasexamen, c(0.25,0.75))
