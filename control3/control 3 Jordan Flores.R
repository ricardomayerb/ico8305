nombres60 <- read.table("/cloud/project/nombres60.xlsx", header=TRUE, quote="\"")
library(readxl)
library(ggplot2)
library(dplyr)
...
# Puede usar los grafico de base o los de ggplot2he
...
# la desviacion estándar de las notas dn
notas$solemne
notas_solemne <- c(notas$solemne)
mean(notas_solemne)
notas$examen
notas_examen <- c(notas$examen)
mean(notas_examen)
