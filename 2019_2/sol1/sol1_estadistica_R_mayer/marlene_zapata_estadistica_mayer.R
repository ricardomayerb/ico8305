...
#MEDIA PIBPERCAPITA
mpib<- mean(misdatos$pib_per_capita)
mpib
#MEDIA ESPERANZA DE VIDA
mesp<- mean(misdatos$esperanza_de_vida)
mesp
#DESVIACION ESTANDAR PIB
dpib<- sd(misdatos$pib_per_capita)
dpib
#DESVIACION ESTANDAR ESPERANZA DE VIDA
desp<- sd(misdatos$esperanza_de_vida)
desp
#CANTIDAD DE OBSERVACIONES PIB
npib<- density(misdatos$pib_per_capita)
npib
#CANTIDAD DE OBSERVACIONES ESPERANZA DE VIDA
nesp<- density(misdatos$esperanza_de_vida)
nesp
...
#LOGARITMO NATURAL DE POBLACION
log(misdatos$poblacion)
