...
mean(misdatos$pib_per_capita)     #11680.07
mean(misdatos$esperanza_de_vida)  #67.00742
# 2.2 la desviación estandar de cada una (4 pts)
sd(misdatos$pib_per_capita)       #12859.94
sd(misdatos$esperanza_de_vida)    #12.07302
# 2.3 la cantidad de observaciones (n) de cada una (4 pts)
length(misdatos$pib_per_capita)    #142
length(misdatos$esperanza_de_vida) #142
...
plot(log(misdatos$pib_per_capita))
plot(log(misdatos$esperanza_de_vida))
