...
#3
hist(datos_e$pib_per_capita,main="histograma pib per capita",col="yellow")
hist(datos_e$esperanza_de_vida,main="histograma esperanza de vida",col="blue")
hist(log(datos_e$poblacion),main="histograma logaritmo natural población",col="pink")
