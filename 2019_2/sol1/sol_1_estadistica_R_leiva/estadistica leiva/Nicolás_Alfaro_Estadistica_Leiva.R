...
median(datos_e$pib_per_capita)
median(datos_e$esperanza_de_vida)
...
sum(datos_e$poblacion)
sum(datos_e$esperanza_de_vida)
sum(datos_e$pib_per_capita)
...
#AMISEMEBORROTODO... en el 2.3 se me olvido el comando que había usado.