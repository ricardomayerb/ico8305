...
mediapib=mean(misdatos$pib_per_capita)
mediaesperanza=mean(misdatos$esperanza_de_vida)
despib=sd(misdatos$pib_per_capita)
desesperanza=sd(misdatos$esperanza_de_vida)
