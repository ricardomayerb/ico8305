...
#7) Compute la proporciónj de gente que obtuvo un azul en el examen                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    # 7) Compute la proporcion de gente que obtuvo un azul en el examen
# azul en el examen opcion 2

computeRestarts(y>=4.0)
