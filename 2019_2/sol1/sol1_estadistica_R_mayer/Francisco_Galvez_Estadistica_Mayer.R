#Alumno: Francisco Galvez Hagedorn
...
#Respuestas
#desviacion estandar pib per capital
sd(misdatos$pib_per_capita)
#desviación estandar esperanza de vida
sd(misdatos$esperanza_de_vida)

# 2.3 la cantidad de observaciones (n) de cada una (4 pts)

#Respuestas
#Todos los datos tienen la misma cantidad, asique la cantidad siempre sera la misma.

nrow(misdatos)


# 3. Grafique los histogramas de estas tres variables:
# "pib_per_capita" (2 pto), "esperanza_de_vida" (2 pto)
