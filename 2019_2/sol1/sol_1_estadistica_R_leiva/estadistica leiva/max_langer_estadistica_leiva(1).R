# nombre del archivo a mandar por correo: #max_langer_estadistica_leiva.R
...
#--> media per capita= 11680,07
mean(misdatos$esperanza_de_vida) 
#--> media esperanza de vida= 67,00742
# 2.2 la desviación estandar de cada una (4 pts)
sd(misdatos$pib_per_capita) 
#--> desviación estandar per capita= 12859,94
sd(misdatos$esperanza_de_vida) 
#--> desviación estandar esperanza de vida= 12,07302
