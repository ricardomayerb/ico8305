# Prueba Solemne Estadística
# Esteban_Céspedes_Estadistica_Leiva
...
#desviación estandar del pib per capita
sd(misdatos$pib_per_capita)
#[1] 12859.94

#desviación estandar de la esperanza de vida
...
# "pib_per_capita" (2 pto)
hist(misdatos$pib_per_capita)

# "esperanza_de_vida" (2 pto)
hist(misdatos$esperanza_de_vida)

# logaritmo natural de la variable "población" (4 pts).
