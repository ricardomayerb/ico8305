# nombre del archivo a mandar por correo:Solemne_RStudio
...
legend(misdatos$pais)
legend(misdatos$continente)
legend(misdatos$anio)
legend(misdatos$esperanza_de_vida)
legend(misdatos$poblacion)
legend(misdatos$pib_per_capita)
