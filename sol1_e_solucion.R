...
# 2.1 la media cada una (2 pts)
# 2.2 la desviación estandar de cada una (2 pts)
# 2.3 la cantidad de observaciones (n) de cada una (2 pts)
...
# "pib_per_capita" (1 pto), "esperanza_de_vida" (1 pto) y el logaritmo natural de la variable "población" (2 pts).
