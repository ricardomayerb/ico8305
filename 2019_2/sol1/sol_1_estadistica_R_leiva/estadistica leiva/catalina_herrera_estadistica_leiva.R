...
# library(readxl)
# misdatos<-read_excel("datos_e.xlxs")
datos_e <- misdatos

mean(datos_e$pib_per_capita) #media_pibpercapita
mean(datos_e$esperanza_de_vida) #media_esperzanzadevida
sd(datos_e$pib_per_capita) #desviacionestandar_pibpercapita
sd(datos_e$esperanza_de_vida) #desviacionestandar_esperanzadevida
var1<-(datos_e$esperanza_de_vida)
var2<-(datos_e$pib_per_capita)

hist(datos_e$pib_per_capita, col="green")
hist(datos_e$esperanza_de_vida, col="pink")
hist(log(poblacion$datos_e))
